...
TEST_CASE( "Number of passed arguments is received", "[read_from_file]" ) {
...
TEST_CASE( "Data files for test are open", "[read_from_file]" ) {
...
TEST_CASE( "First set of points is read", "[read_from_file]" ) {
...
TEST_CASE( "Second set of points is read", "[read_from_file]" ) {
...
TEST_CASE( "Rotation matrix is read", "[read_from_file]" ) {
...
TEST_CASE( "Translation vector is read", "[read_from_file]" ) {
