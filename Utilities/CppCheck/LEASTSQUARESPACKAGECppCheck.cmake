...
OPTION(LEASTSQUARESPACKAGE_USE_CPPCHECK "Enable the use of CppCheck for static analysis." OFF)
IF(LEASTSQUARESPACKAGE_USE_CPPCHECK)
  ...
  IF(CPPCHECK_EXECUTABLE)
    ...
    IF(CPPCHECK_FOUND)
      ...
      #  Define file names
      #
      SET(CPPCHECK_LEASTSQUARESPACKAGE_FILES_LIST
        ${PROJECT_BINARY_DIR}/Utilities/CppCheck/LEASTSQUARESPACKAGEFiles.txt)

      #
      # Configure the files
      #
      CONFIGURE_FILE(
        ${PROJECT_SOURCE_DIR}/Utilities/CppCheck/LEASTSQUARESPACKAGEFiles.txt.in
        ${CPPCHECK_LEASTSQUARESPACKAGE_FILES_LIST})

      SET(CPPCHECK_ARGUMENTS_CODE
        --file-list=${CPPCHECK_LEASTSQUARESPACKAGE_FILES_LIST}
      ...
      ADD_CUSTOM_COMMAND(
        OUTPUT  ${LEASTSQUARESPACKAGE_BINARY_DIR}/CppCheckCodeReport.txt
        COMMAND ${CPPCHECK_EXECUTABLE}
        ARGS    ${CPPCHECK_ARGUMENTS_CODE}
        COMMENT "Coding Style Checker"
      )

      ADD_CUSTOM_TARGET(StaticallyAnalyzeCode DEPENDS ${LEASTSQUARESPACKAGE_BINARY_DIR}/CppCheckCodeReport.txt)

      ADD_TEST(CppCheck ${CPPCHECK_EXECUTABLE} ${CPPCHECK_ARGUMENTS_CODE})

    ENDIF(CPPCHECK_FOUND)
  ENDIF(CPPCHECK_EXECUTABLE)
ENDIF(LEASTSQUARESPACKAGE_USE_CPPCHECK)
