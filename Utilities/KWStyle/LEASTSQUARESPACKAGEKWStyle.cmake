...
OPTION(LEASTSQUARESPACKAGE_USE_KWSTYLE "Enable the use of KWStyle for checking coding style." OFF)
IF(LEASTSQUARESPACKAGE_USE_KWSTYLE)
...
SET(KWSTYLE_CONFIGURATION_FILE 
  ${PROJECT_BINARY_DIR}/Utilities/KWStyle/LEASTSQUARESPACKAGEKWS.xml)

SET(KWSTYLE_LEASTSQUARESPACKAGE_FILES_LIST
  ${PROJECT_BINARY_DIR}/Utilities/KWStyle/LEASTSQUARESPACKAGEFiles.txt)

SET(KWSTYLE_LEASTSQUARESPACKAGE_OVERWRITE_FILE
  ${PROJECT_SOURCE_DIR}/Utilities/KWStyle/LEASTSQUARESPACKAGEOverwrite.txt )

#
# Configure the files
#
CONFIGURE_FILE(
  ${PROJECT_SOURCE_DIR}/Utilities/KWStyle/LEASTSQUARESPACKAGEFiles.txt.in
  ${KWSTYLE_LEASTSQUARESPACKAGE_FILES_LIST})

CONFIGURE_FILE(
  ${PROJECT_SOURCE_DIR}/Utilities/KWStyle/LEASTSQUARESPACKAGEKWS.xml.in
...
SET(KWSTYLE_ARGUMENTS_CODE
  -xml ${KWSTYLE_CONFIGURATION_FILE} -v -D ${KWSTYLE_LEASTSQUARESPACKAGE_FILES_LIST}
  -o ${KWSTYLE_LEASTSQUARESPACKAGE_OVERWRITE_FILE} ${KWSTYLE_EDITOR_FORMAT}
  )

ADD_CUSTOM_COMMAND(
  OUTPUT  ${LEASTSQUARESPACKAGE_BINARY_DIR}/KWStyleCodeReport.txt
  COMMAND ${KWSTYLE_EXECUTABLE}
  ARGS    ${KWSTYLE_ARGUMENTS_CODE}
  COMMENT "Coding Style Checker"
  )

ADD_CUSTOM_TARGET(StyleCheckCode DEPENDS ${LEASTSQUARESPACKAGE_BINARY_DIR}/KWStyleCodeReport.txt)

ADD_TEST(KWStyle ${KWSTYLE_EXECUTABLE} ${KWSTYLE_ARGUMENTS_CODE})

ENDIF(KWSTYLE_FOUND)
ENDIF(KWSTYLE_EXECUTABLE)
ENDIF(LEASTSQUARESPACKAGE_USE_KWSTYLE)
