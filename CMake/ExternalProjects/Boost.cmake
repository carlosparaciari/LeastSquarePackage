...
string(REPLACE "^^" ";" LEASTSQUARESPACKAGE_USE_Boost_LIBRARIES "${LEASTSQUARESPACKAGE_USE_Boost_LIBRARIES}")

set(proj Boost)
set(proj_DEPENDENCIES )
set(Boost_DEPENDS ${proj})

if(NOT DEFINED BOOST_ROOT AND NOT LEASTSQUARESPACKAGE_USE_SYSTEM_Boost)
  ...
  if(LEASTSQUARESPACKAGE_USE_Boost_LIBRARIES)
    string(REPLACE ";" "," _boost_libs "${LEASTSQUARESPACKAGE_USE_Boost_LIBRARIES}")
    foreach(_boost_lib ${LEASTSQUARESPACKAGE_USE_Boost_LIBRARIES})
  ...
  set(_boost_cxxflags )
  if(CMAKE_CXX_FLAGS OR LEASTSQUARESPACKAGE_CXX11_FLAG)
    set(_boost_cxxflags "cxxflags=${LEASTSQUARESPACKAGE_CXX11_FLAG} ${CMAKE_CXX_FLAGS}")
  endif()
  ...
  set(LEASTSQUARESPACKAGE_PREFIX_PATH ${proj_INSTALL}^^${LEASTSQUARESPACKAGE_PREFIX_PATH})
  ...
  # Manual install commands (for a LEASTSQUARESPACKAGE super-build install)
